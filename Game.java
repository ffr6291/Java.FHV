...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        Player player1 = new Player("Despot");
        Player player2 = new Player("Fabian");
        Player player3 = new Player("Mario");
        Player player4 = new Player("Nico");

        player1.joinGame(startingCell);
        player2.joinGame(startingCell);
        player4.joinGame(field3);
        player4.enter(Direction.EAST);
        
        player4.currentPlayerOnline();
